...
"""
This script has to be called after the Station script. Otherwise it will fail.
SIMPLE!
This will parse all the locally stored csv's (3) and insert their data
after validation.

If this script ran twice, it will insert duplicate data in the database.
"""
...
def main():
    ...
    print("total data inserted: {}".format(total))
    print("script completed")
    end_time = datetime.now() - start_time
    print("total time: {} minutes!".format(end_time/60))
